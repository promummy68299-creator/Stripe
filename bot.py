...
# ============================================
BOT_TOKEN = "8704774110:AAGGGw-22CTPpiXlIndbOfH5roHSwY3HG0k"  # CHANGE THIS
ADMIN_IDS = [8279891640]  # CHANGE THIS

# ============================================
# ===== DETECT TELEGRAM VERSION =====
# ============================================
...
try:
    ...
    print(f"📦 Telegram version: {TELEGRAM_VERSION}")
except:
    print("❌ Telegram not installed!")
    sys.exit(1)

# Check if v20+
if TELEGRAM_VERSION and TELEGRAM_VERSION.startswith("20."):
    print("✅ Using v20+ API")
